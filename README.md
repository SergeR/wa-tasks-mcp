...
Реализованы базовые операции: просмотр задач и управление их статусом. Создание задач также поддерживается, но редактирование существующих (названия, описания, исполнителя) пока не реализовано.
